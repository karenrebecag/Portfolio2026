...
const MermaidDiagram = dynamic(
  ...
  { loading: () => <div className="my-8 h-48 animate-pulse rounded-lg border border-border bg-muted/30" aria-hidden /> },
)
...
export default async function AtomWebflowArticlePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <main data-theme-section="light">
      {/* Hero */}
      <section className="relative px-4 lg:px-6 pt-40 pb-20 border-b border-border">
        <Container
          data-reveal-group
          data-stagger="100"
          data-start="top 88%"
        ...
        >
          ...
          <div>
            <p className="mt-8 text-base leading-relaxed text-muted-foreground max-w-[55ch]">
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            <span className="px-3 py-1.5 text-xs font-accent bg-secondary text-secondary-foreground">Webflow</span>
            <span className="px-3 py-1.5 text-xs font-accent bg-secondary text-secondary-foreground">GSAP + ScrollTrigger</span>
            <span className="px-3 py-1.5 text-xs font-accent bg-secondary text-secondary-foreground">Design Systems</span>
            <span className="px-3 py-1.5 text-xs font-accent bg-secondary text-secondary-foreground">AI Agents + MCP</span>
            <span className="px-3 py-1.5 text-xs font-accent bg-secondary text-secondary-foreground">Hybrid Architecture</span>
          </div>
      ...
      <section className="px-4 lg:px-6 py-16 lg:py-24">
        <Container>
          <ArticleTOC
            ...
            levels="h2,h3"
            offset={80}
            reveal={{ stagger: '120', start: 'top 85%', distance: '2em' }}
          >
            <div
              data-reveal-group-nested
              data-stagger="70"
              data-distance="1.25em"
              className="toc-article-content space-y-6 text-[15px] leading-relaxed text-foreground/85"
            >
