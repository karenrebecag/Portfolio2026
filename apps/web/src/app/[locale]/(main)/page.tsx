              ...
              <div className="inline-flex flex-col gap-4 rounded-sm border border-white/20 bg-black/35 backdrop-blur-sm px-5 py-5 sm:px-6 sm:py-6">
                ...
                <div className="flex flex-wrap gap-x-5 gap-y-1.5 opacity-60 text-white">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] leading-none font-accent tracking-wide">Available for freelance</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <svg className="w-3 h-3 shrink-0" viewBox="0 0 640 640" fill="currentColor" aria-hidden="true">
                    ...
                    <span className="text-[11px] leading-none font-accent tracking-wide">Full-time remote</span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] leading-none font-accent tracking-wide">Relocation: Canada, Norway & Japan</span>
                  </div>
                </div>
              </div>
            </div>
