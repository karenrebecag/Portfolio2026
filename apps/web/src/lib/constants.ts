...
export const PLACEHOLDER_PROJECTS = [
  {
    id: '1', title: 'Token-First Design at Scale', slug: 'token-first-design-at-scale', status: 'published' as const,
  ...
  {
    id: '2', title: 'Real-Time Product Intelligence with AI', slug: 'real-time-product-intelligence-with-ai', status: 'published' as const,
  ...
  {
    id: '3', title: 'Component Libraries That Ship', slug: 'component-libraries-that-ship', status: 'published' as const,
  ...
  {
    id: '4', title: 'AI Agents for Non-Technical Teams', slug: 'ai-agents-for-non-technical-teams', status: 'published' as const,
  ...
  {
    id: '5', title: 'Automating Operations with LLMs', slug: 'automating-operations-with-llms', status: 'published' as const,
    category: 'web' as const, role: 'Engineer', year: '2024', featured: false,
