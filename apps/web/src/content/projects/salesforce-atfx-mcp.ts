...
export const salesforceAtfxMcpMeta = {
  ...
  articleSlug: 'salesforce-connector-without-admin-access',
...
export const salesforceAtfxMcpI18n = {
  en: {
    title: 'Live CRM Analytics for a Regulated Broker, Without a Single New Credential',
    summary:
  ...
  es: {
    title: 'Analítica de CRM en vivo para un broker regulado, sin una sola credencial nueva',
    summary:
