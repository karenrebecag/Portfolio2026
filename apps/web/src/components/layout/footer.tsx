      ...
      <Container className="px-4 lg:px-6 pt-20 pb-10">
        ...
        <div className="flex flex-col justify-between gap-4 md:flex-row md:gap-8">
          <div className="flex-1 text-[2.75rem] leading-[1] font-[900] tracking-tighter text-balance md:text-[6vw]">
            ...
            <p data-split="heading" data-split-reveal="words" className="text-[#fdf9ed]/40">{t('tagline_2')}</p>
          </div>
          <div>
        ...
        {/* Divider */}
        <div className="mt-16 mb-8 h-px w-full bg-[#fdf9ed]/10" />

        {/* Middle: bio + CTA */}
        <div className="mb-16 flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <p className="max-w-[48ch] tracking-tight text-balance text-[#fdf9ed]/70 md:text-lg">{t('bio')}</p>
        ...
        <div className="grid grid-cols-1 gap-y-10 text-sm md:grid-cols-16 md:gap-x-6 md:gap-y-12">
          ...
          <div className="order-last col-span-16 md:order-first md:col-span-4">
            ...
            <span className="text-[#fdf9ed]/40 text-xs font-accent">{t('rights')} &copy;&nbsp;2026</span>
          </div>
          ...
          <div className="col-span-8 md:col-span-4">
            <a href="mailto:hello@karenortiz.dev" className="text-[#fdf9ed]/60 hover:text-[#fdf9ed] transition-colors max-w-fit font-accent text-xs">
