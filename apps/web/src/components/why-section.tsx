    ...
    <section data-theme-section="dark" data-reveal-group className="relative bg-surface text-surface-foreground py-40">
      ...
      <Container className="relative px-4 lg:px-6">
        ...
        <div className="text-center mb-8">
          <span className="inline-block px-2 py-1 text-[10px] font-bold uppercase tracking-widest leading-none bg-[#fdf9ed] text-[#11221f] font-accent">
            {t('pill')}
          </span>
        </div>
      ...
      <Container className="relative px-4 lg:px-6 mt-20 pb-10">
        <div className="mb-6 flex items-center justify-between">
          <span className="text-[10px] font-bold uppercase tracking-widest font-accent text-[#fdf9ed]/30">
            {t('services_label')}
          </span>
          <span className="text-[10px] font-accent text-[#fdf9ed]/20">01 — 06</span>
        </div>
